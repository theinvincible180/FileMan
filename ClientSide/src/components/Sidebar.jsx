...
return (
  <div
    ...
    } transition-transform duration-200 ease-in-out w-64 z-40 md:translate-x-0 md:static md:inset-0 
    bg-[var(--bg-color)] text-[var(--text-color)] shadow-lg py-20 bg-opacity-100`}
  >
